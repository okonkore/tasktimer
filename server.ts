...
const staticFiles = new Map<string, { path: string; contentType: string }>([
  ...
  ["/games/shield-tap/index-v2.pck", {
    path: "games/shield-tap/index-v2.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v3.pck", {
    path: "games/shield-tap/index-v3.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v4.pck", {
    path: "games/shield-tap/index-v4.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v5.pck", {
    path: "games/shield-tap/index-v5.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v6.pck", {
    path: "games/shield-tap/index-v6.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v7.pck", {
    path: "games/shield-tap/index-v7.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v8.pck", {
    path: "games/shield-tap/index-v8.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v9.pck", {
    path: "games/shield-tap/index-v9.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v10.pck", {
    path: "games/shield-tap/index-v10.pck",
    contentType: "application/octet-stream",
  }],
  ["/games/shield-tap/index-v11.pck", {
...
export async function handleRequest(
  ...
  if (
    ...
    return await (
      dependencies.chatJoinRequestHandler ??
        handleProductionChatJoinRequests
    )(request);
  }

  if (
    /^\/api\/chat\/rooms\/[A-Za-z0-9_-]{16,64}\/messages(?:\/[0-9A-HJKMNP-TV-Z]{26})?$/
      .test(url.pathname)
  ) {
    return await (dependencies.chatMessageHandler ??
      handleProductionChatMessages)(request);
  }
...
let productionChatRoomHandler:
  | ((request: Request) => Promise<Response>)
  | null = null;
let productionChatJoinRequestHandler:
  | ((request: Request) => Promise<Response>)
  | null = null;
...
async function handleProductionChatJoinRequests(
  request: Request,
): Promise<Response> {
  try {
    await initializeProductionChatHandlers();
    ...
    return await productionChatJoinRequestHandler(request);
  } catch {
    return jsonResponse({ error: "Chat is not configured" }, 503, {
      "cache-control": "no-store",
    });
...
async function handleProductionChatMessages(
  request: Request,
): Promise<Response> {
  try {
    await initializeProductionChatHandlers();
    ...
    return await productionChatMessageHandler(request);
  } catch {
    return jsonResponse({ error: "Chat is not configured" }, 503, {
      "cache-control": "no-store",
    });
...
async function initializeProductionChatHandlers(): Promise<void> {
  ...
  productionChatJoinRequestHandler = createChatJoinRequestHandler(
